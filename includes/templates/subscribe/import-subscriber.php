...
<div class="wrap color-333">
	<h2><?php esc_html_e('Import Subscibers', 'unify_sgc_sms'); ?></h2>
	...
	<p><b>Step 1</b>: On the settings tab, Select Database table, Select our table <b>unify_sgc_sms_subscribers</b> from the dropdown.</p>
	...
	<figure class="wp-block-image"><img src="<?php echo esc_attr(UNIFY_SGC_SMS_GATEWAY_URL); ?>/assets/images/csv_screenshot.png" alt="CSV Screenshot" class="wp-image-73" sizes="(max-width: 1024px) 100vw, 1024px"><figcaption>Fig. 1.1</figcaption></figure>
	...
	<p>When ever you want to send other than Coupons Announcement SMS, just change the SMS content from unifysgcsms SMS Settings page.</p>
</div>